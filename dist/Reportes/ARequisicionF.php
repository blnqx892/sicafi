...
<body>
  <table class="membrete">
    ...
    <tr>
      <td></td>
      <td><strong class="titulos">REPORTE HISTORIAL DE REQUISICIONES POR FECHA</strong></td>
    </tr>
  </table>
  <strong class="tituloG titulos">Desde: <?php echo date("d/m/Y"); ?> || Hasta: <?php echo date("d/m/Y"); ?></strong><br>
  <div class="">
