<div aria-live="polite" aria-atomic="true" class="position-relative">
    ...
    <div class="toast-container position-absolute top-0 end-0 p-3">
        ...
        <div id="toast-question" class="toast align-items-center text-white bg-info border-0" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="d-flex">
                <div class="toast-body">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-question-octagon" viewBox="0 0 16 16">
                    ...
                    <span id="text-question">Hello, world! This is   toast message.</span>
                    <div class="mt-2 pt-2 border-top">
                        <button id="toast-question-aceptar" type="button" class="btn btn-light btn-sm mx-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check-circle-fill " viewBox="0 0 16 16">
                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                            </svg>
                            Aceptar
                        </button>
                        <button type="button" class="btn btn-light btn-sm close-question mx-1">
                ...
                <button type="button" class="btn-close btn-close-white me-2 m-auto close"></button>
            </div>
        </div>
